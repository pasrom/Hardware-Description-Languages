...
%
\lstinputlisting[language=Verilog,label={lst:counter_updn}, caption=Implementierung]{./../code/\codeFolderName\codeFolderNameB/src/\codeFileName.sv}
%
\section{Test Bench}
%
In \autoref{lst:tb_counter_updn} ist die Testbench ersichtlich.
%
\lstinputlisting[language=Verilog,label={lst:tb_counter_updn}, caption=Testbench für den Up / Down Counter]{./../code/\codeFolderName\codeFolderNameB/sim/tb_\codeFileName.sv}
%
